...
export default function Footer() {
  ...
  return (
    <footer
      ...
      style={{ background: '#040912', borderTop: '1px solid rgba(201,162,87,0.15)' }}
      role="contentinfo"
    >
      {/* Top gold line */}
      <div style={{ height: '2px', background: 'linear-gradient(90deg, transparent, rgba(201,162,87,0.6), transparent)' }} />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="mb-4">
              ...
              <div style={{ fontSize: '0.55rem', letterSpacing: '0.45em', color: '#C9A257', marginTop: '2px', textTransform: 'uppercase' }}>
                ── Mortgage Broker ──
              </div>
            </div>
            <p style={{ color: '#5A6275', fontSize: '0.82rem', lineHeight: 1.75, fontFamily: 'Josefin Sans', maxWidth: '340px', marginTop: '12px' }}>
              Dubai&apos;s trusted mortgage broker. We connect you to the UAE&apos;s leading
              banks, negotiate the best rates, and guide you seamlessly from enquiry
              to keys — completely free of charge.
            </p>
            <div className="flex flex-col gap-3 mt-6">
              {[
                { icon: Phone, text: '+971 XX XXX XXXX', href: 'tel:+971000000000' },
                { icon: Mail, text: 'info@alfbanq.ae', href: 'mailto:info@alfbanq.ae' },
                { icon: MapPin, text: 'Dubai, United Arab Emirates', href: undefined },
              ].map(({ icon: Icon, text, href }) => (
                <div key={text} className="flex items-center gap-3">
                  <Icon size={13} style={{ color: '#C9A257', flexShrink: 0 }} aria-hidden="true" />
                  {href ? (
                    <a
                      href={href}
          ...
          {/* Services */}
          <div>
            <h3 style={{ fontFamily: 'Cinzel, serif', fontSize: '0.75rem', color: '#C9A257', letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: '16px' }}>
              Services
            </h3>
            <ul className="flex flex-col gap-2.5">
              {[
                'Residential Mortgage', 'Commercial Property', 'Plot & Land Loans',
                'Equity Release', 'Balance Transfer', 'Islamic Finance', 'International Mortgages',
              ].map((s) => (
                <li key={s}>
                  <button
          ...
          <div>
            ...
            <div
              ...
              style={{ padding: '12px 16px', border: '1px solid rgba(201,162,87,0.2)', borderRadius: '4px' }}
            >
              <span style={{ fontSize: '0.58rem', color: '#C9A257', letterSpacing: '0.25em', fontFamily: 'Josefin Sans', textTransform: 'uppercase' }}>RERA Certified</span>
